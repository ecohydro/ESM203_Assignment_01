...
**Note**: For those of you new to southern CA, August is the height of the Mediterranean dry season, and therefore it hasn’t rained much (if at all) since May. This means that the data on vegetation you are seeing must be associated with irrigated lawns, gardens, or parks and open spaces with numerous deeply-rooted trees.
...
But in reality, as we've seen in the reading, it's a bit more complicated: 
