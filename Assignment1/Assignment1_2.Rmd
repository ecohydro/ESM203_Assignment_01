...
23. How do you think the relationship between vegetation and surface temperature would change if the vegetation was water-stressed?

> Leaving the arrow (>), delete this text and write your answer here

24. We've only simulated the vegetation effects on surface temperature through its impact on the resistance to water transport ($r_W$). What other components of energy balance might the presence or absence of vegetation alter? 

> Leaving the arrow (>), delete this text and write your answer here

25. You've now explored the relationship between vegetation and temperature as well as albedo and temperature. If someone were to ask you if a green (vegetated) roof or a white roof were better from an energy balance perspective, how might you use this model to answer that question?
